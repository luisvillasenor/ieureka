<div id="wrapper"> 
  ...
  <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
          <li class="sidebar-brand"><a><span class="glyphicon glyphicon-user"> <?php echo $this->session->userdata('username');?></span></a></li>
          ...
          <li><a href="<?php echo base_url('dashboard/index');?>"><span class="glyphicon glyphicon-object-align-bottom"> Regalias, Membresias y Precios</span></a></li>
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title">Datos de Sesion</h3>
              </div>
